            ...
            <div className="footer">
                <div className="sections">
                    ...
                    <div className="sections__paragraph">
                        <p><span className="sections__highlight"> Masterstudy</span> is Educational WordPress theme featured by Learning
                         Management System (LMS) for online education.</p>
                        <p>Developed by <span className="sections__highlight">StylemixThemes.</span></p>
                    </div>
                ...
                <div className="sections">
                    ...
                    <br/><br/>
                 <p>Copyright <AiOutlineCopyrightCircle/> 2020 MasterStudy Theme by Stylemix Themes</p>
                    </div>
